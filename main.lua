...
local Window = Rayfield:CreateWindow({
   ...
   KeySettings = {
      Title = "DX Key System",
      Subtitle = nil,
      Note = "To get the key, join our discord server, QmgyFqRcp8",
      ...
      Key = {"DXHUBBLADEBALL"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})
